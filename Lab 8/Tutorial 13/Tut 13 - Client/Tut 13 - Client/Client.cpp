...
/// <summary>
/// This function processes different types of packets recieved by the client.
/// </summary>
...
/// <summary>
/// This function starts a file transfer from the server. 
/// It first checks if a transfer is already in progress. 
/// If not it opens the file and starts the transfer.
/// It returns are error if the file cannot be opened.
/// </summary>
...
/// <summary>
/// This function is for sending packets from the client. 
/// It runs in a loop checking if there are packets and retrieves them.
/// </summary>
