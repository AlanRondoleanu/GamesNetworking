...
/// <summary>
/// This is a constructor for the server. 
/// It sets up WinSock, configures the server, and prepares the server to listen for incoming connections. 
/// If any setup step fails, it shows an error message and exits the program.
/// </summary>
...
/// <summary>
/// This function, ListenForNewConnection, waits for a new client to connect. 
/// If a client connects successfully, it creates a new thread to handle that client, 
/// then sends a welcome message, and updates the total count of connections.
/// </summary>
...
/// <summary>
/// This function handles incoming packets from a client. 
/// If the packet is a chat message, it gets the message and sends it to all other connected clients. 
/// And if the packet type is unknown, it give an error.
/// </summary>
...
/// <summary>
/// This function manages communication with a client.
/// It continuously receives and processes packets from the client.
/// If there’s an issue, it stops the connection and closes the client’s socket.
/// </summary>
